...
public class IdentitiesServiceImpl extends GraphQLServiceBase implements IdentitiesService {
    ...
    public void getIdentityAsync(GetIdentity query, HttpCallback<GraphQLResponse<Identity>> callback) {
        enqueueGraphQLCall(this.service.getIdentity(schemaProvider.get(), query), callback);
    }
    ...
    public void unlinkIdentityAsync(UnlinkIdentity query, HttpCallback<GraphQLResponse<Identity>> callback) {
        enqueueGraphQLCall(this.service.unlinkIdentity(schemaProvider.get(), query), callback);
    }
    ...
    public HttpResponse<GraphQLResponse<Identity>> getIdentitySync(GetIdentity query) throws IOException {
        return executeGraphQLCall(this.service.getIdentity(schemaProvider.get(), query));
    }
