...
public class AppsServiceImpl extends GraphQLServiceBase implements AppsService {
    ...
    public void getAppAsync(GetApp query, HttpCallback<GraphQLResponse<App>> callback) {
        enqueueGraphQLCall(this.service.getApp(schemaProvider.get(), query), callback);
    }
    ...
    public void authAppAsync(AuthApp query, HttpCallback<GraphQLResponse<AuthTokens>> callback) {
        enqueueGraphQLCall(this.service.authApp(schemaProvider.get(), query), callback);
    }
    ...
    public HttpResponse<GraphQLResponse<App>> getAppSync(GetApp query) throws IOException {
        return executeGraphQLCall(this.service.getApp(schemaProvider.get(), query));
    }
    ...
    public HttpResponse<GraphQLResponse<AuthTokens>> authAppSync(AuthApp query) throws IOException {
        return executeGraphQLCall(this.service.authApp(schemaProvider.get(), query));
    }
}
